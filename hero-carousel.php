...
class Widget_Victus_Global_Image_Text_Carousel extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'discription', [
				'label' => __( 'Discription', 'victusglobal-core' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => __( 'Enter Discription Text Here' , 'victusglobal-core' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'hero_slides',
			[
				'label' => __( 'VictusGlobal Image Text Slides', 'victusglobal-core' ),
